...
__fish_brew_complete_arg 'instal' -l non-interactive-sudo -d 'Fail fast on any interactive sudo prompt and use non-interactive sudo where possible'
...
__fish_brew_complete_arg 'install' -l non-interactive-sudo -d 'Fail fast on any interactive sudo prompt and use non-interactive sudo where possible'
