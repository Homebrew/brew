...
__fish_brew_complete_arg 'instal' -l non-interactive-sudo -d 'Fail fast on any interactive sudo prompt and use non-interactive sudo where possible. Enabled by default if `$HOMEBREW_NON_INTERACTIVE` is set'
...
__fish_brew_complete_arg 'instal' -l timeout-wait-for-user -d 'Wait this many seconds when an interactive prompt is detected; then skip the item'
...
__fish_brew_complete_arg 'install' -l non-interactive-sudo -d 'Fail fast on any interactive sudo prompt and use non-interactive sudo where possible. Enabled by default if `$HOMEBREW_NON_INTERACTIVE` is set'
...
__fish_brew_complete_arg 'install' -l timeout-wait-for-user -d 'Wait this many seconds when an interactive prompt is detected; then skip the item'
...
__fish_brew_complete_arg 'upgrade' -l non-interactive -d 'Fail fast on any interactive prompt and use non-interactive sudo where applicable. Enabled by default if `$HOMEBREW_NON_INTERACTIVE` is set'
...
__fish_brew_complete_arg 'upgrade' -l timeout-wait-for-user -d 'Wait this many seconds when an interactive prompt is detected; then skip the item'
