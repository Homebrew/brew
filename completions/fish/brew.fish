# Fish shell completions for DinrusBrew
# This file is automatically generated by running `brew generate-man-completions`.
# See Library/DinrusBrew/completions/fish.erb for editing instructions.
...
function __fish_brew_suggest_formulae_outdated -d "List of outdated formulae with the information about potential upgrade"
    DINRUSBREW_NO_AUTO_UPDATE=1 brew outdated --formula --verbose 2>/dev/null \
...
function __fish_brew_suggest_casks_outdated -d "Lists outdated casks with the information about potential upgrade"
    DINRUSBREW_NO_AUTO_UPDATE=1 brew outdated --cask --verbose 2>/dev/null \
        # replace first space with tab to make the following a description in the completions list:
        | string replace -r '\s' '\t'
end
...
__fish_brew_complete_cmd '--cache' 'Display DinrusBrew\'s download cache'
...
__fish_brew_complete_cmd '--caskroom' 'Display DinrusBrew\'s Caskroom path'
...
__fish_brew_complete_cmd '--cellar' 'Display DinrusBrew\'s Cellar path'
...
__fish_brew_complete_cmd '--config' 'Show DinrusBrew and system configuration info useful for debugging'
...
__fish_brew_complete_cmd '--env' 'Summarise DinrusBrew\'s build environment as a plain list'
...
__fish_brew_complete_cmd '--prefix' 'Display DinrusBrew\'s install path'
...
__fish_brew_complete_arg '--prefix' -l unbrewed -d 'List files in DinrusBrew\'s prefix not installed by DinrusBrew'
...
__fish_brew_complete_cmd '--repo' 'Display where DinrusBrew\'s Git repository is located'
...
__fish_brew_complete_cmd '--repository' 'Display where DinrusBrew\'s Git repository is located'
...
__fish_brew_complete_cmd '--version' 'Print the version numbers of DinrusBrew, DinrusBrew/homebrew-core and DinrusBrew/homebrew-cask (if tapped) to standard output'
...
__fish_brew_complete_arg '-S' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to search their descriptions. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_cmd '-v' 'Print the version numbers of DinrusBrew, DinrusBrew/homebrew-core and DinrusBrew/homebrew-cask (if tapped) to standard output'
...
__fish_brew_complete_cmd 'abv' 'Display brief statistics for your DinrusBrew installation'
__fish_brew_complete_arg 'abv' -l analytics -d 'List global DinrusBrew analytics data or, if specified, installation and build error data for formula (provided neither `$DINRUSBREW_NO_ANALYTICS` nor `$DINRUSBREW_NO_GITHUB_API` are set)'
...
__fish_brew_complete_arg 'abv' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to print their JSON. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_cmd 'analytics' 'Control DinrusBrew\'s anonymous aggregate user behaviour analytics'
...
__fish_brew_complete_cmd 'audit' 'Check formula for DinrusBrew coding style violations'
...
__fish_brew_complete_arg 'audit' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to audit them. Implied if `DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_arg 'audit' -l new -d 'Run various additional style checks to determine if a new formula or cask is eligible for DinrusBrew. This should be used when creating new formulae or casks and implies `--strict` and `--online`'
...
__fish_brew_complete_arg 'bottle' -l root-url -d 'Use the specified URL as the root of the bottle\'s URL instead of DinrusBrew\'s default'
__fish_brew_complete_arg 'bottle' -l root-url-using -d 'Use the specified download strategy class for downloading the bottle\'s URL instead of DinrusBrew\'s default'
...
__fish_brew_complete_cmd 'completions' 'Control whether DinrusBrew automatically links external tap shell completion files'
...
__fish_brew_complete_cmd 'contributions' 'Summarise contributions to DinrusBrew repositories'
...
__fish_brew_complete_arg 'create' -l no-fetch -d 'DinrusBrew will not download URL to the cache and will thus not add its SHA-256 to the formula for you, nor will it check the GitHub API for GitHub projects (to fill out its description and homepage)'
...
__fish_brew_complete_cmd 'debugger' 'Run the specified DinrusBrew command in debug mode'
...
__fish_brew_complete_arg 'desc' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to search their descriptions. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_arg 'determine-test-runners' -l dependents -d 'Determine runners for testing dependents. Requires `--eval-all` or `DINRUSBREW_EVAL_ALL`'
...
__fish_brew_complete_cmd 'developer' 'Control DinrusBrew\'s developer mode'
...
__fish_brew_complete_cmd 'docs' 'Open DinrusBrew\'s online documentation at https://docs.brew.sh in a browser'
...
__fish_brew_complete_cmd 'edit' 'Open a formula, cask or tap in the editor set by `EDITOR` or `DINRUSBREW_EDITOR`, or open the DinrusBrew repository for editing if no argument is provided'
...
__fish_brew_complete_cmd 'environment' 'Summarise DinrusBrew\'s build environment as a plain list'
...
__fish_brew_complete_cmd 'generate-man-completions' 'Generate DinrusBrew\'s manpages and shell completions'
...
__fish_brew_complete_cmd 'home' 'Open a formula or cask\'s homepage in a browser, or open DinrusBrew\'s own homepage if no argument is provided'
...
__fish_brew_complete_cmd 'homepage' 'Open a formula or cask\'s homepage in a browser, or open DinrusBrew\'s own homepage if no argument is provided'
...
__fish_brew_complete_cmd 'info' 'Display brief statistics for your DinrusBrew installation'
__fish_brew_complete_arg 'info' -l analytics -d 'List global DinrusBrew analytics data or, if specified, installation and build error data for formula (provided neither `$DINRUSBREW_NO_ANALYTICS` nor `$DINRUSBREW_NO_GITHUB_API` are set)'
...
__fish_brew_complete_arg 'info' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to print their JSON. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_arg 'instal' -l ignore-dependencies -d 'An unsupported DinrusBrew development option to skip installing any dependencies of any kind. If the dependencies are not already present, the formula will have issues. If you\'re not developing DinrusBrew, consider adjusting your PATH rather than using this option'
...
__fish_brew_complete_arg 'instal' -l interactive -d 'Download and patch formula, then open a shell. This allows the user to run `./configure --help` and otherwise determine how to turn the software package into a DinrusBrew package'
...
__fish_brew_complete_arg 'install' -l interactive -d 'Download and patch formula, then open a shell. This allows the user to run `./configure --help` and otherwise determine how to turn the software package into a DinrusBrew package'
...
__fish_brew_complete_cmd 'install-bundler-gems' 'Install DinrusBrew\'s Bundler gems'
...
__fish_brew_complete_cmd 'irb' 'Enter the interactive DinrusBrew Ruby shell'
...
__fish_brew_complete_arg 'irb' -l pry -d 'Use Pry instead of IRB. Implied if `DINRUSBREW_PRY` is set'
...
__fish_brew_complete_cmd 'link' 'Symlink all of formula\'s installed files into DinrusBrew\'s prefix'
...
__fish_brew_complete_arg 'linkage' -l cached -d 'Print the cached linkage values stored in `DINRUSBREW_CACHE`, set by a previous `brew linkage` run'
...
__fish_brew_complete_cmd 'ln' 'Symlink all of formula\'s installed files into DinrusBrew\'s prefix'
...
__fish_brew_complete_cmd 'log' 'Show the `git log` for formula or cask, or show the log for the DinrusBrew repository if no formula or cask is provided'
...
__fish_brew_complete_cmd 'nodenv-sync' 'Create symlinks for DinrusBrew\'s installed NodeJS versions in `~/.nodenv/versions`'
...
__fish_brew_complete_arg 'pr-pull' -l root-url -d 'Use the specified URL as the root of the bottle\'s URL instead of DinrusBrew\'s default'
__fish_brew_complete_arg 'pr-pull' -l root-url-using -d 'Use the specified download strategy class for downloading the bottle\'s URL instead of DinrusBrew\'s default'
...
__fish_brew_complete_arg 'pr-upload' -l root-url -d 'Use the specified URL as the root of the bottle\'s URL instead of DinrusBrew\'s default'
__fish_brew_complete_arg 'pr-upload' -l root-url-using -d 'Use the specified download strategy class for downloading the bottle\'s URL instead of DinrusBrew\'s default'
...
__fish_brew_complete_cmd 'prof' 'Run DinrusBrew with a Ruby profiler'
...
__fish_brew_complete_cmd 'pyenv-sync' 'Create symlinks for DinrusBrew\'s installed Python versions in `~/.pyenv/versions`'
...
__fish_brew_complete_cmd 'rbenv-sync' 'Create symlinks for DinrusBrew\'s installed Ruby versions in `~/.rbenv/versions`'
...
__fish_brew_complete_arg 'readall' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_arg 'readall' -l syntax -d 'Syntax-check all of DinrusBrew\'s Ruby files (if no tap is passed)'
...
__fish_brew_complete_arg 'reinstall' -l interactive -d 'Download and patch formula, then open a shell. This allows the user to run `./configure --help` and otherwise determine how to turn the software package into a DinrusBrew package'
...
__fish_brew_complete_cmd 'release' 'Create a new draft DinrusBrew/brew release with the appropriate version number and release notes'
...
__fish_brew_complete_cmd 'rubocop' 'Installs, configures and runs DinrusBrew\'s `rubocop`'
...
__fish_brew_complete_cmd 'ruby' 'Run a Ruby instance with DinrusBrew\'s libraries loaded'
...
__fish_brew_complete_cmd 'rubydoc' 'Generate DinrusBrew\'s RubyDoc documentation'
...
__fish_brew_complete_arg 'search' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to search their descriptions. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_cmd 'setup-ruby' 'Installs and configures DinrusBrew\'s Ruby'
...
__fish_brew_complete_cmd 'sh' 'Enter an interactive shell for DinrusBrew\'s build environment'
...
__fish_brew_complete_cmd 'style' 'Check formulae or files for conformance to DinrusBrew style guidelines'
...
__fish_brew_complete_arg 'tap' -l eval-all -d 'Evaluate all the formulae, casks and aliases in the new tap to check validity. Implied if `$DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_cmd 'tests' 'Run DinrusBrew\'s unit and integration tests'
...
__fish_brew_complete_arg 'unbottled' -l eval-all -d 'Evaluate all available formulae and casks, whether installed or not, to check them. Implied if `DINRUSBREW_EVAL_ALL` is set'
...
__fish_brew_complete_cmd 'unlink' 'Remove symlinks for formula from DinrusBrew\'s prefix'
...
__fish_brew_complete_cmd 'up' 'Fetch the newest version of DinrusBrew and all formulae from GitHub using `git`(1) and perform any necessary migrations'
...
__fish_brew_complete_cmd 'update-license-data' 'Update SPDX license data in the DinrusBrew repository'
...
__fish_brew_complete_cmd 'update-maintainers' 'Update the list of maintainers in the `DinrusBrew/brew` README'
...
__fish_brew_complete_cmd 'update-reset' 'Fetch and reset DinrusBrew and all tap repositories (or any specified repository) using `git`(1) to their latest `origin/HEAD`'
...
__fish_brew_complete_cmd 'update-sponsors' 'Update the list of GitHub Sponsors in the `DinrusBrew/brew` README'
...
__fish_brew_complete_arg 'update-test' -l to-tag -d 'Set `DINRUSBREW_UPDATE_TO_TAG` to test updating between tags'
...
__fish_brew_complete_arg 'upgrade' -l interactive -d 'Download and patch formula, then open a shell. This allows the user to run `./configure --help` and otherwise determine how to turn the software package into a DinrusBrew package'
...
__fish_brew_complete_cmd 'vendor-gems' 'Install and commit DinrusBrew\'s vendored gems'
...
__fish_brew_complete_cmd 'vendor-install' 'Install DinrusBrew\'s portable Ruby'
...
__fish_brew_complete_cmd 'services' "Integrates DinrusBrew formulae with macOS's launchctl manager"
