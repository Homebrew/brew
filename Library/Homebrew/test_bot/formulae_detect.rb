  ...
  module TestBot
    ...
    diff_end_sha1     #{diff_end_sha1.presence           || "(blank)"}
        ...
        if tap && diff_start_sha1 != diff_end_sha1
          ...
          @added_formulae +=
            T.must(diff_formulae(diff_start_sha1, diff_end_sha1, formula_path, "A"))
          modified_formulae +=
            T.must(diff_formulae(diff_start_sha1, diff_end_sha1, formula_path, "M"))
          @deleted_formulae +=
            T.must(diff_formulae(diff_start_sha1, diff_end_sha1, formula_path, "D"))
        end
