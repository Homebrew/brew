...
RSpec.describe Cask::Artifact::Deb, :cask, :needs_linux do
  let(:cask) { Cask::CaskLoader.load(cask_path("with-deb")) }
  ...
  describe ".from_args" do
    it "creates a Deb artifact with the specified path" do
