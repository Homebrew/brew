...
#           Service::FormulaWrapper.new(name: "name", service_name: "service.name", service_startup?: false), enable: false
#         )
...
#       expect do
#         services_cli.service_load(Service::FormulaWrapper.new(name: "name", service_name: "service.name", service_startup?: true),
#                                   enable: false)
#       end.to output(out).to_stdout
#     end
#
...
#       expect do
#         services_cli.service_load(
#           Service::FormulaWrapper.new(name: "name", service_name: "service.name", service_startup?: false,
