...
RSpec.describe Service::FormulaWrapper do
  ...
  let(:service_object) do
    instance_double(Services::Service,
                    requires_root?: false,
                    timed?:         false,
                    keep_alive?:    false,
                    command:        "/bin/cmd",
  ...
  before do
    ...
    allow(Service::System).to receive_messages(launchctl?: true, systemctl?: false, root?: false, user: "testuser",
                                               boot_path: Pathname.new("/Library/LaunchDaemons"), user_path: Pathname.new("/tmp_home/Library/LaunchAgents"))
  end
