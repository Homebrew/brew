...
module Minitest
  module TestProf
  class BaseReporter < Minitest::AbstractReporter
...
module Minitest
  module TestProf
  class EventProfReporter < Minitest::TestProf::BaseReporter
...
module Minitest
  module TestProf
  class FactoryDoctorReporter < Minitest::TestProf::BaseReporter
  def initialize(io = T.unsafe(nil), options = T.unsafe(nil)); end
...
Minitest::TestProf::FactoryDoctorReporter::SUCCESS_MESSAGE = T.let(T.unsafe(nil).freeze, String)

module Minitest
  module TestProf
  class MemoryProfReporter < Minitest::TestProf::BaseReporter
  def initialize(io = T.unsafe(nil), options = T.unsafe(nil)); end
...
TestProf::EventProf::Configuration::INSTRUMENTERS = T.let(T.unsafe(nil).freeze, Hash)
...
module TestProf
  module EventProf
  module Monitor
  class TopLevelTracker < TestProf::EventProf::Monitor::BaseTracker
  def initialize(event); end
...
module TestProf
  module EventProf
  class Profiler
  def initialize(event:, instrumenter:, rank_by: T.unsafe(nil), top_count: T.unsafe(nil), per_example: T.unsafe(nil))
  end
...
TestProf::FactoryAllStub::LOCAL_NAME = T.let(T.unsafe(nil).freeze, Symbol)
module TestProf
  module FactoryBotStrategy; end
end
...
TestProf::FactoryDoctor::IGNORED_QUERIES_PATTERN = T.let(T.unsafe(nil).freeze, Regexp)
...
TestProf::FactoryProf::FACTORY_BUILDERS = T.let(T.unsafe(nil).freeze, Array)
...
TestProf::FactoryProf::Printers::Flamegraph::OUTPUT_NAME = T.let(T.unsafe(nil).freeze, String)
TestProf::FactoryProf::Printers::Flamegraph::TEMPLATE = T.let(T.unsafe(nil).freeze, String)
...
TestProf::Logging::COLORS = T.let(T.unsafe(nil).freeze, Hash)
...
module TestProf
  module MemoryProf
  class AllocPrinter < TestProf::MemoryProf::Printer
    private
...
module TestProf
  module MemoryProf
  class AllocTracker < TestProf::MemoryProf::Tracker
  def supported?; end
  def track; end
  end
  end
...
TestProf::MemoryProf::Printer::NumberToHuman::BASE = T.let(T.unsafe(nil).freeze, Integer)
TestProf::MemoryProf::Printer::NumberToHuman::UNITS = T.let(T.unsafe(nil).freeze, Array)

module TestProf
  module MemoryProf
  class RssPrinter < TestProf::MemoryProf::Printer
    private
...
module TestProf
  module MemoryProf
  class RssTracker < TestProf::MemoryProf::Tracker
...
TestProf::MemoryProf::Tracker::RssTool::TOOLS = T.let(T.unsafe(nil).freeze, Hash)
...
TestProf::RSpecStamp::EXAMPLE_RXP = T.let(T.unsafe(nil).freeze, Regexp)
...
TestProf::RubyProf::Configuration::LOGFILE_PREFIX = T.let(T.unsafe(nil).freeze, String)
TestProf::RubyProf::Configuration::PRINTERS = T.let(T.unsafe(nil).freeze, Hash)
TestProf::RubyProf::Configuration::PRINTER_EXTENSTION = T.let(T.unsafe(nil).freeze, Hash)
...
TestProf::StackProf::Configuration::FORMATS = T.let(T.unsafe(nil).freeze, Array)
module TestProf
  module StringTruncate; end
end
...
TestProf::TagProf::Printers::HTML::OUTPUT_NAME = T.let(T.unsafe(nil).freeze, String)
TestProf::TagProf::Printers::HTML::TEMPLATE = T.let(T.unsafe(nil).freeze, String)
...
TestProf::VERSION = T.let(T.unsafe(nil).freeze, String)
