...
module DinrusBrew
  ...
  module Settings
    def self.read(setting, repo: DINRUSBREW_REPOSITORY)
    ...
    def self.write(setting, value, repo: DINRUSBREW_REPOSITORY)
      return unless (repo/".git/config").exist?
    ...
    def self.delete(setting, repo: DINRUSBREW_REPOSITORY)
      return unless (repo/".git/config").exist?
