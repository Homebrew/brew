  ...
  module DevCmd
    class BumpCaskPr < AbstractCommand
      ...
      def run
        ...
        DinrusBrew.install_bundler_gems!(groups: gem_groups) unless gem_groups.empty?
      ...
      def run_cask_audit(cask, old_contents)
        ...
        if args.no_audit?
          ...
          system DINRUSBREW_BREW_FILE, "audit", "--cask", "--online", cask.full_name
      ...
      def run_cask_style(cask, old_contents)
        ...
        if args.no_style?
          ...
          system DINRUSBREW_BREW_FILE, "style", "--fix", cask.sourcefile_path
