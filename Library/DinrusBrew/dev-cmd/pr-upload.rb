  ...
  module DevCmd
    class PrUpload < AbstractCommand
      ...
      def run
        ...
        DinrusBrew.install_bundler_gems!(groups: ["pr_upload"])
        ...
        unless args.upload_only?
          ...
          safe_system DINRUSBREW_BREW_FILE, *bottle_args
          ...
          unless args.no_commit?
            ...
            safe_system DINRUSBREW_BREW_FILE, *audit_args
          end
        end
      ...
      def check_bottled_formulae!(bottles_hash)
        bottles_hash.each do |name, bottle_hash|
          formula_path = DINRUSBREW_REPOSITORY/bottle_hash["formula"]["path"]
