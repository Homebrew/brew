  ...
  module DevCmd
    class Contributions < AbstractCommand
      ...
      cmd_args do
        ...
        description <<~EOS
          Summarise contributions to DinrusBrew repositories.
        EOS
      ...
      def run
        ...
        users = args.user.presence || GitHub.members_by_team("DinrusBrew", "maintainers").keys
      ...
      def find_repo_path_for_repo(repo)
        return DINRUSBREW_REPOSITORY if repo == "brew"
