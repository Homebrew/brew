  ...
  module DevCmd
    class BumpFormulaPr < AbstractCommand
      ...
      def run
        ...
        ENV["BROWSER"] = DinrusBrew::EnvConfig.browser
        ...
        DinrusBrew.install_bundler_gems!(groups: ["audit", "style"]) unless args.no_audit?
      ...
      def run_audit(formula, alias_rename, old_contents)
        ...
        if args.no_audit?
          ...
          system DINRUSBREW_BREW_FILE, "audit", *audit_args, formula.full_name
          failed_audit = !$CHILD_STATUS.success?
        else
          system DINRUSBREW_BREW_FILE, "audit", formula.full_name
          failed_audit = !$CHILD_STATUS.success?
        end
