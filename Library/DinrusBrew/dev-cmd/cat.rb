    ...
    class Cat < AbstractCommand
      ...
      def run
        cd DINRUSBREW_REPOSITORY do
          pager = if DinrusBrew::EnvConfig.bat?
            ENV["BAT_CONFIG_PATH"] = DinrusBrew::EnvConfig.bat_config_path
            ENV["BAT_THEME"] = DinrusBrew::EnvConfig.bat_theme
