...
RSpec.describe DinrusBrew::Cmd::Info do
  ...
  describe "::github_remote_path" do
    let(:remote) { "https://github.com/DinrusBrew/homebrew-core" }

    specify "returns correct URLs" do
      expect(described_class.new([]).github_remote_path(remote, "Formula/git.rb"))
        .to eq("https://github.com/DinrusBrew/homebrew-core/blob/HEAD/Formula/git.rb")
