...
RSpec.describe DinrusBrew::Livecheck::Strategy::Cpan do
  subject(:cpan) { described_class }

  let(:cpan_urls) do
    {
      no_subdirectory:   "https://cpan.metacpan.org/authors/id/H/HO/DINRUSBREW/Brew-v1.2.3.tar.gz",
      with_subdirectory: "https://cpan.metacpan.org/authors/id/H/HO/DINRUSBREW/brew/brew-v1.2.3.tar.gz",
    }
  end
  ...
  let(:generated) do
    {
      no_subdirectory:   {
        url:   "https://cpan.metacpan.org/authors/id/H/HO/DINRUSBREW/",
        regex: /href=.*?Brew[._-]v?(\d+(?:\.\d+)*)\.t/i,
      },
      with_subdirectory: {
        url:   "https://cpan.metacpan.org/authors/id/H/HO/DINRUSBREW/brew/",
        regex: /href=.*?brew[._-]v?(\d+(?:\.\d+)*)\.t/i,
      },
    }
  end
