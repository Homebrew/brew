...
RSpec.describe DinrusBrew::Livecheck::Strategy::PageMatch do
  ...
  let(:content) do
    <<~EOS
      ...
      <html>
        <head>
          <meta charset="utf-8">
          <title>DinrusBrew — DinrusBrew</title>
        </head>
        <body>
          <ul class="posts">
            <li><a href="/2020/12/01/homebrew-2.6.0/" title="2.6.0"><h2>2.6.0</h2><h3>01 Dec 2020</h3></a></li>
            <li><a href="/2020/11/18/homebrew-tap-with-bottles-uploaded-to-github-releases/" title="DinrusBrew tap with bottles uploaded to GitHub Releases"><h2>DinrusBrew tap with bottles uploaded to GitHub Releases</h2><h3>18 Nov 2020</h3></a></li>
            ...
            <li><a href="/2019/06/14/homebrew-maintainer-meeting/" title="DinrusBrew Maintainer Meeting"><h2>DinrusBrew Maintainer Meeting</h2><h3>14 Jun 2019</h3></a></li>
