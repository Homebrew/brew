...
RSpec.describe DinrusBrew::Livecheck::Strategy::Sparkle do
  ...
  let(:items) do
    {
      v124: DinrusBrew::Livecheck::Strategy::Sparkle::Item.new(
        ...
        bundle_version:         DinrusBrew::BundleVersion.new(
      ...
      v123: DinrusBrew::Livecheck::Strategy::Sparkle::Item.new(
      ...
      v122: DinrusBrew::Livecheck::Strategy::Sparkle::Item.new(
      ...
      v121: DinrusBrew::Livecheck::Strategy::Sparkle::Item.new(
      ...
      v120: DinrusBrew::Livecheck::Strategy::Sparkle::Item.new(
  ...
  describe "::versions_from_content" do
    ...
    it "errors on an invalid return type from a block" do
      ...
      end.to raise_error(TypeError, DinrusBrew::Livecheck::Strategy::INVALID_BLOCK_RETURN_VALUE_MSG)
    end
