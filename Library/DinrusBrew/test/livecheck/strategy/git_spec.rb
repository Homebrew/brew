...
RSpec.describe DinrusBrew::Livecheck::Strategy::Git do
  subject(:git) { described_class }

  let(:git_url) { "https://github.com/DinrusBrew/brew.git" }
  ...
  describe "::preprocess_url" do
    let(:github_git_url_with_extension) { "https://github.com/DinrusBrew/brew.git" }
    ...
    it "returns the Git repository URL for a GitHub URL not ending in .git" do
      expect(git.preprocess_url("https://github.com/DinrusBrew/brew"))
        .to eq(github_git_url_with_extension)
    end

    it "returns the unmodified URL for a GitHub /releases/latest URL" do
      expect(git.preprocess_url("https://github.com/DinrusBrew/brew/releases/latest"))
        .to eq("https://github.com/DinrusBrew/brew/releases/latest")
    end

    it "returns the Git repository URL for a GitHub AWS URL" do
      expect(git.preprocess_url("https://github.s3.amazonaws.com/downloads/DinrusBrew/brew/1.0.0.tar.gz"))
        .to eq(github_git_url_with_extension)
    end

    it "returns the Git repository URL for a github.com/downloads/... URL" do
      expect(git.preprocess_url("https://github.com/downloads/DinrusBrew/brew/1.0.0.tar.gz"))
        .to eq(github_git_url_with_extension)
    end

    it "returns the Git repository URL for a GitHub tag archive URL" do
      expect(git.preprocess_url("https://github.com/DinrusBrew/brew/archive/1.0.0.tar.gz"))
        .to eq(github_git_url_with_extension)
    end

    it "returns the Git repository URL for a GitHub release archive URL" do
      expect(git.preprocess_url("https://github.com/DinrusBrew/brew/releases/download/1.0.0/brew-1.0.0.tar.gz"))
        .to eq(github_git_url_with_extension)
    end

    it "returns the Git repository URL for a gitlab.com archive URL" do
      expect(git.preprocess_url("https://gitlab.com/DinrusBrew/brew/-/archive/1.0.0/brew-1.0.0.tar.gz"))
        .to eq("https://gitlab.com/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for a self-hosted GitLab archive URL" do
      expect(git.preprocess_url("https://brew.sh/DinrusBrew/brew/-/archive/1.0.0/brew-1.0.0.tar.gz"))
        .to eq("https://brew.sh/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for a Codeberg archive URL" do
      expect(git.preprocess_url("https://codeberg.org/DinrusBrew/brew/archive/brew-1.0.0.tar.gz"))
        .to eq("https://codeberg.org/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for a Gitea archive URL" do
      expect(git.preprocess_url("https://gitea.com/DinrusBrew/brew/archive/brew-1.0.0.tar.gz"))
        .to eq("https://gitea.com/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for an Opendev archive URL" do
      expect(git.preprocess_url("https://opendev.org/DinrusBrew/brew/archive/brew-1.0.0.tar.gz"))
        .to eq("https://opendev.org/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for a tildegit archive URL" do
      expect(git.preprocess_url("https://tildegit.org/DinrusBrew/brew/archive/brew-1.0.0.tar.gz"))
        .to eq("https://tildegit.org/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for a LOL Git archive URL" do
      expect(git.preprocess_url("https://lolg.it/DinrusBrew/brew/archive/brew-1.0.0.tar.gz"))
        .to eq("https://lolg.it/DinrusBrew/brew.git")
    end

    it "returns the Git repository URL for a sourcehut archive URL" do
      expect(git.preprocess_url("https://git.sr.ht/~DinrusBrew/brew/archive/1.0.0.tar.gz"))
        .to eq("https://git.sr.ht/~DinrusBrew/brew")
    end
  end
  ...
  describe "::versions_from_tags" do
    ...
    it "errors on an invalid return type from a block" do
      expect { git.versions_from_tags(tags[:normal]) { 123 } }
        .to raise_error(TypeError, DinrusBrew::Livecheck::Strategy::INVALID_BLOCK_RETURN_VALUE_MSG)
    end
  end
end
