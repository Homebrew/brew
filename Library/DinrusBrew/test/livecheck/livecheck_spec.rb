...
RSpec.describe DinrusBrew::Livecheck do
  subject(:livecheck) { described_class }

  let(:cask_url) { "https://brew.sh/test-0.0.1.dmg" }
  let(:head_url) { "https://github.com/DinrusBrew/brew.git" }
  ...
  let(:f) do
    formula("test") do
      ...
      head "https://github.com/DinrusBrew/brew.git"
  ...
  describe "::checkable_urls" do
    ...
    let(:f_duplicate_urls) do
      formula("test_duplicate_urls") do
        ...
        homepage "https://github.com/DinrusBrew/brew.git"
        url "https://brew.sh/test-0.0.1.tgz"
        head "https://github.com/DinrusBrew/brew.git"
      end
    end
