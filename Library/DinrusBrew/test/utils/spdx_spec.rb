...
RSpec.describe SPDX do
  ...
  describe ".license_expression_to_string" do
    ...
    it "returns licenses and exceptions for complex license expressions" do
      ...
      result = "MIT OR LicenseRef-DinrusBrew-public-domain OR (0BSD AND Zlib) OR (curl WITH LLVM-exception)"
      expect(described_class.license_expression_to_string(license_expression)).to eq result
    end

    it "returns :public_domain" do
      expect(described_class.license_expression_to_string(:public_domain)).to eq "LicenseRef-DinrusBrew-public-domain"
    end

    it "returns :cannot_represent" do
      result = "LicenseRef-DinrusBrew-cannot-represent"
  ...
  describe ".string_to_license_expression" do
    ...
    it "returns :public_domain" do
      expect(described_class.string_to_license_expression("LicenseRef-DinrusBrew-public-domain")).to eq :public_domain
    end

    it "returns :cannot_represent" do
      expr_string = "LicenseRef-DinrusBrew-cannot-represent"
