...
RSpec.describe DinrusBrew::DevCmd::TapNew do
  ...
  it "initializes a new tap with a README file and GitHub Actions CI", :integration_test do
    ...
    expect(DINRUSBREW_LIBRARY/"Taps/homebrew/homebrew-foo/README.md").to exist
    expect(DINRUSBREW_LIBRARY/"Taps/homebrew/homebrew-foo/.github/workflows/tests.yml").to exist
  end
end
