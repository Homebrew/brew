...
RSpec.describe DinrusBrew::DevCmd::Irb do
  ...
  describe "integration test" do
    ...
    it "starts an interactive DinrusBrew shell session", :integration_test do
      setup_test_formula "testball"

      irb_test = DINRUSBREW_TEMP/"irb-test.rb"
      irb_test.write <<~RUBY
        "testball".f
        :testball.f
        exit
      ...
      expect { brew "irb", irb_test }
        .to output(/Interactive DinrusBrew Shell/).to_stdout
