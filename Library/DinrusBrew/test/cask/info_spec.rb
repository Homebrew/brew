...
RSpec.describe Cask::Info, :cask do
  let(:args) { instance_double(DinrusBrew::Cmd::Info::Args) }

  before do
    # Prevent unnecessary network requests in `Utils::Analytics.cask_output`
    ENV["DINRUSBREW_NO_ANALYTICS"] = "1"
  end
  ...
  it "displays some nice info about the specified Cask" do
    expect do
      ...
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/l/local-transmission.rb
      ==> Name
      Transmission
      ==> Description
      BitTorrent client
  ...
  it "prints cask dependencies if the Cask has any" do
    expect do
      ...
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/with-depends-on-cask-multiple.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it "prints cask and formulas dependencies if the Cask has both" do
    expect do
      ...
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/with-depends-on-everything.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it "prints auto_updates if the Cask has `auto_updates true`" do
    expect do
      ...
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/with-auto-updates.rb
      ==> Name
      AutoUpdates
      ==> Description
      None
  ...
  it "prints caveats if the Cask provided one" do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/with-caveats.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it 'does not print "Caveats" section divider if the caveats block has no output' do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/with-conditional-caveats.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it "prints languages specified in the Cask" do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/with-languages.rb
      ==> Name
      None
      ==> Description
      None
  ...
  it 'does not print "Languages" section divider if the languages block has no output' do
    expect do
      ...
      https://brew.sh/
      Not installed
      From: https://github.com/DinrusBrew/homebrew-cask/blob/HEAD/Casks/w/without-languages.rb
      ==> Name
      None
      ==> Description
      None
