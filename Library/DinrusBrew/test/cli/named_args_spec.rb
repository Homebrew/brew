...
RSpec.describe DinrusBrew::CLI::NamedArgs do
  ...
  describe "#to_kegs" do
    before do
      (DINRUSBREW_CELLAR/"foo/1.0").mkpath
      (DINRUSBREW_CELLAR/"foo/2.0").mkpath
      (DINRUSBREW_CELLAR/"bar/1.0").mkpath
    end
  ...
  describe "#to_default_kegs" do
    before do
      (DINRUSBREW_CELLAR/"foo/1.0").mkpath
      (DINRUSBREW_CELLAR/"bar/1.0").mkpath
      linked_path = (DINRUSBREW_CELLAR/"foo/2.0")
      linked_path.mkpath
  ...
  describe "#to_latest_kegs" do
    before do
      ...
      (DINRUSBREW_CELLAR/"foo/2.0").mkpath
      (DINRUSBREW_CELLAR/"bar/1.0").mkpath
      (DINRUSBREW_CELLAR/"baz/HEAD-1").mkpath
      head2 = DINRUSBREW_CELLAR/"baz/HEAD-2"
      head2.mkpath
  ...
  describe "#to_installed_taps" do
    before do
      (DINRUSBREW_REPOSITORY/"Library/Taps/homebrew/homebrew-foo").mkpath
    end
