...
RSpec.describe InstalledDependents do
  ...
  describe "::find_some_installed_dependents" do
    ...
    # 1.1.6 is the earliest version of DinrusBrew that generates correct runtime
    ...
    def unreliable_tab_dependencies(keg, deps)
      # 1.1.5 is (hopefully!) the last version of DinrusBrew that generates
    ...
    specify "renamed dependency" do
      ...
      renamed_path = DINRUSBREW_CELLAR/"foo-old"
      (DINRUSBREW_CELLAR/"foo").rename(renamed_path)
