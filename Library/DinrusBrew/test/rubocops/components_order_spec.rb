        ...
        class Foo < Formula
          ...
          on_macos do
            ...
            resource "resource1" do
              ...
              patch do
                url "https://raw.githubusercontent.com/DinrusBrew/formula-patches/0ae366e6/patch3.diff"
            ...
            patch do
              url "https://raw.githubusercontent.com/DinrusBrew/formula-patches/0ae366e6/patch1.diff"
              sha256 "89fa3c95c329ec326e2e76493471a7a974c673792725059ef121e6f9efb05bf4"
            end

            patch do
              url "https://raw.githubusercontent.com/DinrusBrew/formula-patches/0ae366e6/patch2.diff"
              sha256 "89fa3c95c329ec326e2e76493471a7a974c673792725059ef121e6f9efb05bf4"
            end
          end
