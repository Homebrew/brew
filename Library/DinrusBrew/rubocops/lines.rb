...
module RuboCop
  module Cop
    module FormulaAudit
      # This cop checks for various miscellaneous DinrusBrew coding styles.
        ...
        def audit_formula(formula_nodes)
          ...
          find_method_with_args(body_node, :skip_clean, :all) do
            problem "`skip_clean :all` is deprecated; brew no longer strips symbols. " \
                    "Pass explicit paths to prevent DinrusBrew from removing empty folders."
          end
          ...
          find_instance_method_call(body_node, "ENV", :[]) do |method|
            ...
            problem 'Don\'t use ENV["CI"] for DinrusBrew CI checks.'
          end
