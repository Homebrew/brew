    ...
    class Reinstall < AbstractCommand
      cmd_args do
        description <<~EOS
          ...
          Unless `$DINRUSBREW_NO_INSTALL_CLEANUP` is set, `brew cleanup` will then be run for the
      ...
      def run
        ...
        if args.build_from_source?
          ...
          unless DinrusBrew::EnvConfig.developer?
        ...
        unless formulae.empty?
          ...
          formulae.each do |formula|
            ...
            DinrusBrew::Reinstall.reinstall_formula(
              formula,
