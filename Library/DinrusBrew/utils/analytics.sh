...
# DINRUSBREW_LINUX, DINRUSBREW_REPOSITORY is set by bin/brew
# DINRUSBREW_NO_ANALYTICS is from the user environment.
# shellcheck disable=SC2154

setup-analytics() {
  local git_config_file="${DINRUSBREW_REPOSITORY}/.git/config"
