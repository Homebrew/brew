...
# This is an autogenerated file for dynamic methods in `DinrusBrew::EnvConfig`.
# Please instead update this file by running `bin/tapioca dsl DinrusBrew::EnvConfig`.


module DinrusBrew::EnvConfig
  class << self
