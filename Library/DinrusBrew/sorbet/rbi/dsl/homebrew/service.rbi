...
# This is an autogenerated file for dynamic methods in `DinrusBrew::Service`.
# Please instead update this file by running `bin/tapioca dsl DinrusBrew::Service`.


class DinrusBrew::Service
