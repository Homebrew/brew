...
# This is an autogenerated file for dynamic methods in `DinrusBrew::Cmd::UpgradeCmd`.
# Please instead update this file by running `bin/tapioca dsl DinrusBrew::Cmd::UpgradeCmd`.


class DinrusBrew::Cmd::UpgradeCmd
  sig { returns(DinrusBrew::Cmd::UpgradeCmd::Args) }
  def args; end
end

class DinrusBrew::Cmd::UpgradeCmd::Args < DinrusBrew::CLI::Args
