...
# This is an autogenerated file for dynamic methods in `DinrusBrew::Cmd::Reinstall`.
# Please instead update this file by running `bin/tapioca dsl DinrusBrew::Cmd::Reinstall`.


class DinrusBrew::Cmd::Reinstall
  sig { returns(DinrusBrew::Cmd::Reinstall::Args) }
  def args; end
end

class DinrusBrew::Cmd::Reinstall::Args < DinrusBrew::CLI::Args
