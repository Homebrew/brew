...
# This is an autogenerated file for dynamic methods in `RuboCop::Cop::DinrusBrew::NoFileutilsRmrf`.
# Please instead update this file by running `bin/tapioca dsl RuboCop::Cop::DinrusBrew::NoFileutilsRmrf`.


class RuboCop::Cop::DinrusBrew::NoFileutilsRmrf
