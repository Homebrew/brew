...
module DinrusBrew
  module Livecheck
    module Strategy
      ...
      #
      # * `https://cpan.metacpan.org/authors/id/H/HO/DINRUSBREW/Brew-v1.2.3.tar.gz`
      # * `https://cpan.metacpan.org/authors/id/H/HO/DINRUSBREW/brew/brew-v1.2.3.tar.gz`
      #
      # In these examples, `DINRUSBREW` is the author name and the preceding `H`
