...
class LinkageChecker
  ...
  def check_dylibs(rebuild_cache:)
    ...
    # See: https://github.com/DinrusBrew/brew/blob/e689cc07/Library/DinrusBrew/extend/os/linux/extend/ENV/super.rb#L53
    # This results in formulae showing linkage with gcc whenever it is installed, even if no dependency is declared.
    # See discussions at:
    #   https://github.com/DinrusBrew/brew/pull/13659
    #   https://github.com/DinrusBrew/brew/pull/13796
