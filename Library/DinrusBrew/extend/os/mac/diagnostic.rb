    ...
    module Diagnostic
      ...
      module Checks
        ...
        def check_for_unsupported_macos
          ...
          return if ENV["DINRUSBREW_INTEGRATION_TEST"]
        ...
        def check_xcode_up_to_date
          ...
          # `brew test-bot` runs `brew doctor` in the CI for the DinrusBrew/brew
          # repository. This only needs to support whatever CI providers
          # DinrusBrew/brew is currently using.
          ...
          return if ENV["DINRUSBREW_FAKE_MACOS"]
        ...
        def check_for_gettext
          ...
          if gettext&.linked_keg&.directory?
            allowlist = ["#{DINRUSBREW_CELLAR}/gettext"]
            if ::Hardware::CPU.physical_cpu_arm64?
              allowlist += %W[
                #{DINRUSBREW_MACOS_ARM_DEFAULT_PREFIX}/Cellar/gettext
                #{DINRUSBREW_DEFAULT_PREFIX}/Cellar/gettext
              ]
            end
        ...
        def check_for_iconv
          ...
          if libiconv&.linked_keg&.directory?
            ...
            inject_file_list @found, <<~EOS
              ...
              DinrusBrew doesn't provide a libiconv formula and expects to link against
        ...
        def check_for_multiple_volumes
          ...
          # Find the volumes for the TMP folder & DINRUSBREW_CELLAR
          real_cellar = DINRUSBREW_CELLAR.realpath
          where_cellar = volumes.which real_cellar

          begin
            tmp = Pathname.new(Dir.mktmpdir("doctor", DINRUSBREW_TEMP))
            begin
          ...
          <<~EOS
            ...
            You should set the "DINRUSBREW_TEMP" environment variable to a suitable
...
DinrusBrew::Diagnostic::Checks.prepend(OS::Mac::Diagnostic::Checks)
