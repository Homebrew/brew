...
module Stdenv
  ...
  def homebrew_extra_pkg_config_paths
    [Pathname("#{DINRUSBREW_LIBRARY}/DinrusBrew/os/mac/pkgconfig/#{MacOS.version}")]
  end
  ...
  def remove_macosxsdk(version = nil)
    ...
    delete("CPATH")
    remove "LDFLAGS", "-L#{DINRUSBREW_PREFIX}/lib"
  ...
  def macosxsdk(version = nil, formula: nil, testing_formula: false)
    ...
    self["CPATH"] = "#{DINRUSBREW_PREFIX}/include"
    prepend "LDFLAGS", "-L#{DINRUSBREW_PREFIX}/lib"
