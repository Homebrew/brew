...
# residing in the `DINRUSBREW_CACHE`.
#
class CacheStoreDatabase
  ...
  # database file will be created in the `DINRUSBREW_CACHE` with a name
  ...
  # The path where the database resides in the `DINRUSBREW_CACHE` for the given
  # `@type`.
  #
  # @return [String]
  def cache_path
    DINRUSBREW_CACHE/"#{@type}.json"
  end
