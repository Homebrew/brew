...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/linuxbrew/.linuxbrew/Cellar/portable-ruby/3.3.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/linuxbrew/.linuxbrew/Cellar/portable-ruby/3.3.7' '--enable-load-relative' '--with-static-linked-ext' '--with-baseruby=/home/linuxbrew/.linuxbrew/Homebrew/Library/Homebrew/vendor/portable-ruby/3.3.6/bin/ruby' '--without-ext=win32,win32ole' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' '--with-libyaml-dir=/home/linuxbrew/.linuxbrew/opt/portable-libyaml' '--with-libffi-dir=/home/linuxbrew/.linuxbrew/opt/portable-libffi' '--with-zlib-dir=/home/linuxbrew/.linuxbrew/opt/portable-zlib' 'MKDIR_P=/bin/mkdir -p' 'ac_cv_lib_z_uncompress=no' 'cflags=-fPIC' 'cxxflags=-fPIC' 'CC=cc' 'CXX=c++'"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lrt -lrt -lrt -ldl -lcrypt -lm -lpthread "
