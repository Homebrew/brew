...
option(DINRUSBREW_ALLOW_FETCHCONTENT "Разрешить использовать FetchContent в построениях DinrusBrew" OFF)

if (DINRUSBREW_ALLOW_FETCHCONTENT)
    return()
endif()

macro(trap_fetchcontent_provider method depName)
    message(FATAL_ERROR "Refusing to populate dependency '${depName}' with FetchContent while building in DinrusBrew, please use a formula dependency or add a resource to the formula.")
endmacro()
