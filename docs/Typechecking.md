...
### The [`sorbet`] directory

[`sorbet`]: https://github.com/Homebrew/brew/tree/HEAD/sorbet

The [`Library/Homebrew/sorbet/rbi`] directory contains all Ruby Interface (`.rbi`) files auto-generated by running `brew typecheck --update`:

[`Library/Homebrew/sorbet/rbi`]: https://github.com/Homebrew/brew/tree/HEAD/Library/Homebrew/sorbet/rbi

- `gems`: RBI files for all gems are generated using [Tapioca](https://github.com/Shopify/tapioca#tapioca).
- `dsl`: RBI files auto-generated by our [Tapioca compilers](https://github.com/Homebrew/brew/tree/HEAD/sorbet/tapioca/compilers).
