...
| [`remove_generated_completions`](/rubydoc/Cask/Staged.html#remove_generated_completions-instance_method) | `uninstall_postflight` | Remove completion files generated by `generate_completions_from_executable`. |
