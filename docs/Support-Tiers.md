...
We may assist the maintainers/contributors/developers of such packages to fix bugs with the Homebrew formula/cask/tap system but are not responsible for resolving issues when using that software.
